...
<body>
    ...
    <header class="header">
        <div class="header-content">
            ...
            <div class="header-title">
                <h1>Clara</h1>
                <p>Diário - Registre seus sentimentos</p>
            </div>
    ...
    <div class="container">
        ...
        <nav class="nav-tabs">
            ...
            <a href="diario.php" class="nav-tab active" data-section="diario">
                📔 Diário
            </a>
        ...
        <div class="chat-header">
            <div class="chat-header-icon purple">📔</div>
            <div>
                <h3>Diário</h3>
                <p>Registre seus sentimentos e experiências</p>
            </div>
        </div>
        ...
        <div class="chat-container">
            <div class="chat-messages" id="chatMessages">
                <div class="message clara">
                    <div class="message-content">
                        <div class="message-text">Que bom que você quer registrar seus sentimentos! 📔 Como você está se sentindo hoje? Pode me contar sobre seu dia...</div>
            ...
            <form class="chat-input chat-form">
                <div class="input-group">
                    <textarea 
                        class="chat-textarea" 
                        placeholder="Escreva sobre seus sentimentos, seu dia ou qualquer coisa que queira registrar..."
                        rows="2"
                    ></textarea>
    ...
    <script>
        ...
        fetch('api/messages.php?section=diario')
